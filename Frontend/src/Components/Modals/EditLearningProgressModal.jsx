...
const EditLearningProgressModal = () => {
  ...
  return (
    <Modal
      title={
        <Title level={4} style={{ color: themeColors.textPrimary }}>
          Edit Learning Plan
        </Title>
      }
    ...
    >
      ...
      >
        ...
        >
          <Input placeholder="Enter plan name" style={{ borderRadius: 8 }} />
        </Form.Item>
        ...
        <Form.Item name="routines" label="Skills to Learn (comma separated)">
          <Input
        ...
        <Form.Item name="goal" label="Tutorials & Resources">
          <TextArea
